...
def avg(split,trials):
	...
	for trial in range(0,trials):
		# temp[trial,:] = np.loadtxt('./acc_data/split_0.05/hodge_acc_split,0.05,trial,'+str(trial+1))
...
np.savetxt('hodge_test_LC_avg',avg_test)
np.savetxt('hodge_train_LC_avg',avg_train)
